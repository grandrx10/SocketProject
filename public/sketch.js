    ...
    $("#myModal").on("hidden.bs.modal", function () {
      if (!userNameSubmitted) {
        ...
        socket.emit("username", [
          ...
          $("input[type='radio'][name='team']:checked").val(),
        ]);
      }
    });
...
function draw() {
  ...
  if (bullets != []) {
    for (var i = 0; i < bullets.length; i++) {
      if (
        bullets[i].x > players[socket.id].x + 600 ||
        bullets[i].x < players[socket.id].x - 600 ||
        bullets[i].y < players[socket.id].y - 300 ||
        bullets[i].y > players[socket.id].y + 300
      ) {
      } else {
        ...
        if (
          bullets[i].type == "beam" ||
          bullets[i].type == "trap" ||
          bullets[i].type == "ultrahealing" ||
          bullets[i].type == "rush" ||
          bullets[i].type == "rushStun"
        ) {
          rect(
            bullets[i].x - base,
            bullets[i].y - range,
  ...
  if (gameStart) {
    for (player in players) {
      if (
        players[player].class == "assassin" &&
        gameTime - players[player].canShootCooldown < players[player].shootTime
      ) {
        fill(76, 0, 153);
        if (players[player].dir == "left") {
          rect(
            players[player].x - 20 - base,
            players[player].y + 10 - range,
            20,
            12
          );
        ...
        players[player].class == "huntsman" &&
        gameTime - players[player].canAbility1Cooldown > 0 &&
        gameTime - players[player].canAbility1Cooldown < 2
      ) {
        fill("yellow");
        if (players[player].dir == "left") {
          rect(
      ...
      if (players[player].invis == true) {
        if (socket.id == player) {
          fill(204, 255, 255);
          rect(
            players[player].x - base,
            players[player].y - range,
            20,
          ...
          if (players[player].class == "assassin") {
            ...
            fill("white");
            rect(
              players[player].x - 5 - base,
              players[player].y - 35 - range,
              30,
              5
            );
            fill("black");
            if (
              gameTime - players[player].invisCooldown <
                players[player].invisTime &&
              players[player].invisTime != 0
            ) {
              rect(
                players[player].x - 5 - base,
                players[player].y - 35 - range,
            ...
            fill("green");
            rect(
              players[player].x - base - 1,
              players[player].y - range - 2,
              22,
              12
            );
            if (
              players[player].dir == "left" ||
              players[player].dir == "down"
            ) {
              fill("BLUE");
              rect(
                players[player].x - base + 1,
              ...
              fill("BLUE");
              rect(
                players[player].x - base + 3,
                players[player].y - range + 2,
                5,
                5
              );
              rect(
                players[player].x - base + 14,
                players[player].y - range + 2,
                5,
                5
              );
          ...
          if (players[player].xAcceleration != players[player].xOrigA) {
            ...
            rect(
              players[player].x - 5 - base,
              players[player].y - 40 - range,
              ((gameTime - players[player].speedCooldown) /
                players[player].speedTime) *
                30,
              5
            );
          }
        ...
        if (socket.id == player) {
          ...
          fill(87, 109, 255);
          rect(
            600 - players[player].width / 2,
            300 - players[player].height / 2,
        ...
        if (players[player].stun == true) {
          ...
          rect(
            players[player].x - 5 - base,
            players[player].y - 30 - range,
            30,
            5
          );
          fill("YELLOW");
          if (
            gameTime - players[player].stunCooldown <
            players[player].stunTime
          ) {
            rect(
              players[player].x - 5 - base,
              players[player].y - 30 - range,
            ...
            gameTime - players[player].stunCooldown2 <
            players[player].stunTime
          ) {
            rect(
              players[player].x - 5 - base,
        ...
        if (players[player].marked == true) {
          ...
          fill("CYAN");
          if (
            gameTime - players[player].markTimer <
            players[player].markDuration
          ) {
            rect(
              players[player].x - 5 - base,
              players[player].y - 35 - range,
        ...
        if (
          players[player].class == "tt" &&
          socket.id == player &&
          players[player].canUltimateCooldown == 0
        ) {
          fill(0, 0, 0, 50);
          rect(
            players[player].pastX - base,
            players[player].pastY - range,
            20,
            40,
            0.1
          );
        } else if (
          players[player].class == "ae" &&
        ...
        if (players[player].class == "ae") {
          ...
          rect(
            players[player].x - base + 6,
            players[player].y - range + 4,
            8,
            8
          );
        } else if (players[player].class == "watcher") {
        ...
        if (players[player].class == "tt") {
          ...
          if (players[player].dir == "down") {
            ...
            fill("black");
            rect(
              players[player].x - base + 25,
              players[player].y - range + 10,
              5,
              5
            );
            fill(252, 50, 77);
          ...
          fill("BROWN");
          rect(
            players[player].x - base - 8,
            players[player].y + 5 - range,
            36,
            5
          );
          ...
          for (var i = 0; i < players[player].ammo; i++) {
            rect(
              players[player].x - base - 3 + (i - 1) * 6.6,
              players[player].y - range - 5,
              6.6,
              3
            );
          ...
          if (players[player].dir == "left") {
            ...
            rect(
              players[player].x - base + 21,
              players[player].y - range + 16,
              10,
              20
            );
          } else if (players[player].dir == "up") {
...
function displayTeamRadio(teamMode) {
  if (teamMode == "tdm") {
    $("#team").html(
      '<p>Choose a team:</p><input type="radio" id="teamA" name="team" value="teamA" checked><label for="teamA">TEAM A</label><br><input type="radio" id="teamB" name="team" value="teamB"><label for="teamB">TEAM B</label><br>'
    );
  }
}
